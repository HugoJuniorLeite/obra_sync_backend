...
//pega o employee_id por req.params e filtra os serviços que o técnico está habilitado a fazer
service_router.get("/service-by-occupation/:employee_id", service_controller.get_service_by_occupation_controller);
