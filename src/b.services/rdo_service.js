...
async function create_rdo_service(mapped_body) {
    //console.log(mapped_body, "service");
    
     if (!mapped_body || !mapped_body.bill_id) {
        throw new Error("Campos obrigatórios faltando");
    }
    try {
        await rdo_repository.create_rdo_repository(mapped_body);
